...
<body>
	...
	<form:form action="addShipment" commandName="shipping" method="post">
		<div class="panel panel-info">
			<div class="panel-heading" style="font-size: 17px"><strong><u>SHIPPING DETAILS</u></strong></div>
		</div>
		<div class="container">
			...
			<br> <br> <input type="submit"
				class="btn btn-success btn-block" style="width: 40%" value="PROCEED"
