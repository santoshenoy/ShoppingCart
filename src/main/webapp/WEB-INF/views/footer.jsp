	...
	<div class="navbar-bottom navbar-default" role="navigation"
		...
		<div class="row">
			...
			<div class="col-xs-3 col-md-3">
				...
				<li><a href="https://plus.google.com/" style="color: white">GooglePlus</a></li>
			...
			<div class="col-xs-3 col-md-3">
				...
				<li><a href="terms.jsp" style="color: white">Terms and
						Conditions</a></li>
				<li><a href="privacy.jsp" style="color: white">Privacy</a></li>
				<li><a href="infringement.jsp" style="color: white">Infringement</a></li>
				<li><a href="security.jsp" style="color: white">Security</a></li>
			</div>
		</div>
	</div>
	<br>
